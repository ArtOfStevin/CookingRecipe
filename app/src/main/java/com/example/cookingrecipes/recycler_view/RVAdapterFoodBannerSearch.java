...
public class RVAdapterFoodBannerSearch extends RecyclerView.Adapter<RVAdapterFoodBannerSearch.ViewHolder>{
    ...
    public RVAdapterFoodBannerSearch(List<FoodBanner> foodBannerList, @NonNull BtnClickableCallback btnClickableCallback, String username){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RVAdapterFoodBannerSearch.ViewHolder(view);
    }
